...
// TODO: Refactor duplicate methods for CommandSender and Player
public class Message {
    ...
    public static void to(final Player receiver, final String message) {
        receiver.sendMessage(StringUtils.translateColors(message));
    }

    public static void to(final Player receiver, String... messages) {
        receiver.sendMessage(StringUtils.translateColors(String.join("\n", messages)));
    }

    public static void to(final Player receiver, final IPropertyAccessor propertyAccessor,
            final String key) {
        receiver.sendMessage(StringUtils.translateColors(propertyAccessor.getString(key)));
    }
    ...
    @SafeVarargs
    public static void to(final Player receiver, final IPropertyAccessor properties,
            final String key, Pair<String, Object>... placeholders) {
        receiver
                .sendMessage(StringUtils
                        .translateColors(StringUtils.replacePlaceholders(properties.getString(key), placeholders)));
